...
RSpec.describe Geometry::D2::Ray do
  ...
  describe '#direction' do
    it 'should return a correct vector' do
      expect(r1.direction).to eq(Geometry::D2::Vector.new(1, 1))
      expect(r2.direction).to eq(Geometry::D2::Vector.new(-1, 1))
    end
  end
  ...
  describe '#similar_to?' do
    ...
    it 'should return true' do
      ...
      expect(r1.similar_to?(Geometry::D2::Line.new([2, 2], [4, 4]))).to be true
      expect(r1.similar_to?(Geometry::D2::Segment.new([2, 2], [4, 4]))).to be true
  ...
  describe '#intersection' do
    ...
    context 'intersection with a point' do
      it 'should return array with our point' do
        ...
        expect(r1.intersection([55, 55])).to eq([Geometry::D2::Point.new(55, 55)])
      end
    ...
    context 'intersection with a linear entity which lies on one line' do
      it 'should return array with self when intersection with line' do
        ...
        expect(r1.intersection(Geometry::D2::Line.new([10, 10], [20, 20]))).to eq([r1])
      end
      ...
      it 'should return array with results when intersection with no line' do
        ...
        expect(r1.intersection(Geometry::D2::Segment.new([-1, -1], [0, 0]))).to eq([p1])
        ...
        expect(described_class.new([0.5, 0.5], p2).intersection(s1)).to eq([
          Geometry::D2::Segment.new([0.5, 0.5], p2)
        ])
        expect(described_class.new([0.5, 0.5], p1).intersection(s1)).to eq([
          Geometry::D2::Segment.new([0.5, 0.5], p1)
        ])
    ...
    context 'intersection with a linear entity which does not lie on one line' do
      context 'intersection with parallel linear entity' do
        it 'should return empty array' do
          ...
          expect(r1.intersection(Geometry::D2::Line.new([1, 0], [2, 1]))).to eq([])
          expect(r3.intersection(described_class.new([0, 1], [1, 1]))).to eq([])
          expect(r3.intersection(Geometry::D2::Segment.new([0, 1], [1, 1]))).to eq([])
        end
      end
      ...
      context 'intersection with not parallel linear entity' do
        it 'should return array with point' do
          ...
          expect(Geometry::D2::Segment.new([-10, 0], [10, 0]).intersection(described_class.new([-3, 0.9], [1, 0.3]))).to eq([
        ...
        it 'should return empty array' do
          ...
          expect(r3.intersection(Geometry::D2::Segment.new([-0.001, 0], [-0.001, 2]))).to eq([])
          expect(r3.intersection(Geometry::D2::Segment.new([1, 1], [4, 0.0001]))).to eq([])
        end
      end
    end
  end
  ...
  describe '#perpendicular_segment' do
    ...
    it 'should return a perpendicular segment' do
      expect(r2.perpendicular_segment(p2)).to eq(Geometry::D2::Segment.new(p2, p1))
      expect(r3.perpendicular_segment(p2)).to eq(Geometry::D2::Segment.new(p2, p3))
      expect(r3.perpendicular_segment(Geometry::D2::Point.new(2, 2))).to eq(
  ...
  describe '#span_test' do
    ...
    it 'should return correct number' do
      ...
      expect(r1.span_test(Geometry::D2::Point.new(-1, -1))).to eq(-1)
    end
  end
  ...
  describe '#contains?' do
    ...
    it 'should contains segment' do
      ...
      expect(r1.contains?(Geometry::D2::Segment.new(
        [271, 271], [373, 373]
      ))).to be true
  ...
  describe '#distance' do
    ...
    it 'should return 0' do
      ...
      expect(r1.distance(Geometry::D2::Point.new(1000, 1000))).to eq(0)
    end

    it 'should return correct number' do
      expect(r1.distance(Geometry::D2::Point.new(-1, -1))).to eq(Math.sqrt(2))
      expect(r1.distance(Geometry::D2::Point.new(-1, 1))).to eq(Math.sqrt(2))
    end
  end
  ...
  describe '#==' do
    ...
    it 'should be equal' do
      ...
      expect(r1 == Geometry::D2::Ray.new([0, 0], [100, 100])).to be true
